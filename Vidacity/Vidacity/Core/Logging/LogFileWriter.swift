...
/// the OSLogStore every 5 seconds, filters by `subsystem == "app.vidacity"`, and
...
final class LogFileWriter {
    ...
    @ObservationIgnored private let log = AppLog(subsystem: "app.vidacity", category: "LogFileWriter")
    ...
    nonisolated static let subsystem = "app.vidacity"
