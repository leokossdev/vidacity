...
final class DownloadsStore {
    ...
    nonisolated static let didChange = Notification.Name("app.vidacity.downloadsDidChange")
    ...
    nonisolated static let metadataXattrKey = "app.vidacity.downloadMetadata"
    ...
    @ObservationIgnored private let log = AppLog(subsystem: "app.vidacity", category: "DownloadsStore")
