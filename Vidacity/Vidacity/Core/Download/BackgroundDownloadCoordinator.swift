...
/// 1. In `VidacityApp.init`, call `BackgroundDownloadCoordinator.shared.registerBackgroundTasks()`.
...
final class BackgroundDownloadCoordinator: NSObject {
    ...
    static let sessionIdentifier = "app.vidacity.downloads"
    static let bgTaskIdentifier = "app.vidacity.resume-downloads"

    private let log = AppLog(subsystem: "app.vidacity", category: "BGDownloads")
