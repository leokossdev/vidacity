...
actor PythonRunner {
    ...
    @ObservationIgnored private nonisolated let log = AppLog(subsystem: "app.vidacity", category: "PythonRunner")
...
final class PythonSerialExecutor: SerialExecutor, @unchecked Sendable {
    ...
    // SSL data.
    private let queue = DispatchQueue(label: "app.vidacity.python", qos: .utility)
...
final class DownloadManager: TemporaryDownloading {
    ...
    @ObservationIgnored private let log = AppLog(subsystem: "app.vidacity", category: "DownloadManager")
    ...
    private static func makeTemporaryCookiesFile() -> URL? {
        ...
        var lines = [
            ...
            "# Generated by Vidacity; deleted on yt-dlp completion.",
        ]
    ...
    private func waitForAllowedNetwork() async throws {
        ...
        throw YouTubeServiceError.network(NSError(
            domain: "Vidacity.DownloadManager",
            code: -1,
