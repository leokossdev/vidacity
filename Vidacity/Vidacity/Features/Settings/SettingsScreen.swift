        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    Text("yt-dlp is the engine that resolves YouTube stream URLs. Vidacity auto-refreshes it every 7 days from the official GitHub release. Tap Update now if a video stops playing — newer versions often fix breakage caused by YouTube's API changes.")
                }
                ...
                Section {
                    Text("Vidacity is a personal/sideload-only YouTube client. It uses YouTubeKit (cookie-based, no Google API key) plus yt-dlp for downloads. YouTube can change its internal API at any time — please be patient when things break.")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                } header: {
                    Text("About")
