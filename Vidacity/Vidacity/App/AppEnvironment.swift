...
/// Shared singletons placed into the SwiftUI environment by `VidacityApp`.
...
final class AppEnvironment {
    ...
    /// Console.app subsystem `app.vidacity/JSEvaluator`. Remove or downgrade once the
    /// integration work is shipped.
    private func runJavaScriptCoreSmokeTest() {
        let log = AppLog(subsystem: "app.vidacity", category: "JSEvaluator")
