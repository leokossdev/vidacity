...
/// `VidacityApp` via `.commands { MacCommands(player:) }`.
///
...
struct MacCommands: Commands {
    ...
    /// player has to be threaded through from `VidacityApp`.
...
extension Notification.Name {
    ...
    static let freetubeSelectTab = Notification.Name("app.vidacity.selectTab")
}
